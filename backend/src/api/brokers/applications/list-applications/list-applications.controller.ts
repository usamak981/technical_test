...
import { Body, Controller, Get, HttpCode, HttpException, HttpStatus, Inject, Post, Query, UseGuards, Req } from '@nestjs/common';
...
export class BrokerApplicationsListController {
  ...
  async post(
    ...
    @Req() req: Request
     ...
     console.log("Request Body: ", req.body, body, user.id);
