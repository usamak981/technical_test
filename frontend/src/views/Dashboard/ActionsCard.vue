...
const submitForm = () => {
  const formElement = document.getElementById('applicant_form');
  if (formElement) {
...
<template>
  <div class="action-section">
    ...
    <BModal :visible="modal.isVisible.value" :confirm="modal.confirm">
      ...
      <form id="applicant_form" @submit.prevent="submitApplication()">
        ...
        <template #footer>
          <BButton type="submit" form="applicant_form" variant="primary" label="Submit" ></BButton>
